# -*- coding: utf-8 -*-
# This code is from: https://github.com/avhn/peakdetect
# However this repository has been archived by the owner on Aug 23, 2022. It is now read-only.
# I needed to fix a bug but could not push it anymore into the original repo.
# My solution is to bring the code in findpeaks. I am not in favor of this but could not see any other solution.
# 
